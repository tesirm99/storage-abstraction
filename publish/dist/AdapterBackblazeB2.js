...
const backblaze_b2_1 = __importDefault(require("@nichoth/backblaze-b2"));
...
class AdapterBackblazeB2 extends AbstractAdapter_1.AbstractAdapter {
    ...
    getFiles(bucketName_1, versioning_1) {
        return __awaiter(this, arguments, void 0, function* (bucketName, versioning, numFiles = 1000) {
